        ...
        <div class="topBanner" >
         ...
         <br></br>
            ...
            <ul class="infoAttract">
                <li>Address : 95 Luang Naimueng Mueng Ubon Ratchatani Ubon Ratchatani 34000</li>
                <li>Tel : +66 4524 6060</li>
                <li>Opening time : 6:00 - 21:00</li>
                <li>Fee : -</li>
                <li>Category : Temple,Landmark</li>
            </ul>
